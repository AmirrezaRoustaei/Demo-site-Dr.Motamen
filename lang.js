...
function setLanguage(lang) {
  if (lang === "en") {
    ...
    document.getElementById("headerSubtitle").innerText = "Orthopedic Surgeon — 13 years of experience";
    ...
    document.getElementById("aboutText").innerText = "Dr. Mohammad Motamen, orthopedic Surgeon with over 13 years of experience treating bone, joint, and spine problems.";


    document.getElementById("medicalIdLabel").innerText = "Medical Council Number:";
    
    document.getElementById("membership").innerText = "Member of the European Orthopedic Surgeons Association — Prague Reg. No: MA EU020 M774-ORTHOPEDIST, Member since: 2.10.2012";
